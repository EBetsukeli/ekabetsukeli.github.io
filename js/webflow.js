...
! function(t) {
    ...
    var D = e.frame = function() {
      ...
      W = l(function(e) {
        function n() {
          ...
          if (r)
            for (D(n), e = I(), t = r; t--;)(i = u[t]) && i.render(e)
        }
        var i = {
          ease: f.ease[1],
          from: 0,
        ...
        e.init = function(t) {
          ...
          var t;
          this.active || (this.start || (this.start = I()), this.active = !0, t = this, 1 === u.push(t) && D(n))
        }, e.stop = function() {
          var e, n, i;
  ...
  r.define("forms", t.exports = function(t, e) {
    ...
    function y(e, n) {
      ...
      r.handler = null, r.redirect = i.attr("data-redirect"), g.test(s) ? r.handler = O : s || (o ? r.handler = "function" == typeof hostedSubmitWebflow ? hostedSubmitWebflow : _ : b())
    }
    ...
    function A(n, i) {
      ...
      c && "/" === c.attr("href") && null == c.attr("aria-label") && c.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(m), a.button.off(m), a.menu.off(m), C(a), s ? (T(a), a.el.on("setting" + m, function(t) {
        return function(n, i) {
          i = i || {};
          var r = f.width();
          C(t), !0 === i.open && q(t, !0), !1 === i.open && $(t, !0), t.open && e.defer(function() {
            r !== f.width() && R(t)
          })
        }
      }(a))) : (! function(e) {
      ...
      }(a), a.button.on("click" + m, z(a)), a.menu.on("click" + m, "a", M(a)), a.button.on("keydown" + m, function(t) {
        return function(e) {
          switch (e.keyCode) {
            case o.SPACE:
            case o.ENTER:
    ...
    function q(t, e) {
      if (!t.open) {
        ...
        var r = F(t),
          ...
          u = t.el.height(),
          c = t.el[0];
        if (I(0, c), k.intro(0, c), i.redraw.up(), s || d.on("click" + m, t.outside), e) p();
        else {
